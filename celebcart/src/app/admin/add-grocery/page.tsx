...
function page() {
 ...
 return (
   ...
   className='bg-white w-full max-x-2xl shadow-2xl rounded-3xl border border-green-100 p-8'
   >
    ...
    onSubmit={handelSubmit}>
      <div>
        ...
        <input type="text" id='name' placeholder='eg: sweets,Milk...' onChange={(e)=>setName(e.target.value)} value={name} className='w-full border border-gray-300 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-green-400 transition-all'/>
      </div>

      <div className='grid grid-cols-1 sm:grid-cols-2 gap-3'>
        <div >
          <label className='block text-gray-700 font-medium mb-1'>Categories <span className='text-red-500'>*</span></label>
        ...
        <div>
        <label className='block text-gray-700 font-medium mb-1'>Units <span className='text-red-500'>*</span></label>
      ...
      <div>
        ...
        <input type="text" id='name' placeholder='eg. 0000' className='w-full border border-gray-300 rounded-xl px-4 py-3 outline-none focus:ring-2 focus:ring-green-400 transition-all' onChange={(e)=>setPrice(e.target.value)} value={price}/>
      </div>

      <div className='flex flex-col sm:flex-row items-center gap-5'>
        <label htmlFor="image" className='flex flex-col sm:flex-row items-center justify-center gap-2 bg-green-50 text-green-700 font-semibold border border-green-200 rounded-xl px-6 py-3 hover:bg-green-100 transition-all w-full sm:w-auto'> <Upload /> Upload Image</label>

        <input type="file" accept='image/*' hidden id='image' onChange={handelImageChange} />
