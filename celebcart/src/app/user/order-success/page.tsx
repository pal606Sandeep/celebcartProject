...
function OrderSuccess() {
  return (
    <div className='flex flex-col items-center justify-center min-h-[80vh] px-6 text-center bg-linear-to-b from-green-50 to-white'>
      ...
      className='relative'
      >
        <CheckCircle className='text-green-600 w-24 md:w-28 md:h-28'/>
        <motion.div 
        ...
        >
          <div className='w-full h-full rounded-full bg-green-950 blur-2xl'/>
        </motion.div>
      </motion.div>
      <motion.h1
      ...
      >
        Thank you for shopping with us! Your order has been placed and is being processed. You can track its progress in your <span className='font-semibold text-green-700'>My Order</span> Section
      </motion.p>
      <motion.div
