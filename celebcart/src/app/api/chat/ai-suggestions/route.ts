...
export async function POST(req:NextRequest){
    try {
        ...
        👉 If role is "delivery_boy" -> generate 3 short WhatsApp-style reply suggestions that a delivery boy could send the user.
        ...
        -Must be helpful, respectful, and relevant to delivery, status, gelp,or location.
