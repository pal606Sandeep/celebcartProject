...
return (
 <div className='pt-28 w-[90%] md:w-[80%] mx-auto'>
    ...
    <div className='bg-white border-gray-100 rounded-2xl dhadow-md p-5 mb-10'>
        <h2 className='text-lg font-semibold text-gray-700 mb-4'>📈Order Overview (Last & Days)</h2>
        <ResponsiveContainer width="100%" height={300}>
            <BarChart data={chartData}>
            <CartesianGrid stroke="#aaa" strokeDasharray="5 5" />
            <XAxis dataKey="day" height={50} />
            <Tooltip/>
