...
function RegisterForm({previousStep}:propType) {
  ...
  return (
    <div className='flex flex-col items-center justify-center min-h-screen px-6 py-10 bg-linear-to-b from-green-100 to-white'>
       ...
       <p className='flex items-center text-gray-800'>Join Celebcart Today <Leaf className='text-green-600 w-5 h-5'/></p>
       ...
       <p className='cursor-pointer text-gray-600 mt-6 text-sm flex items-center gap-1' onClick={()=>router.push("/signin")}>Already have an Account <LogIn className='w-4 h-4'/> <span className='text-green-600'> Sign In</span></p>
